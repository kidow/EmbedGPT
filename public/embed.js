...
// if (block && block.id) {
//   fetch('http://localhost:3000/api/c?id=' + block.id, {
//     method: 'GET'
//   })
//     .then((res) => res.json())
//     .then((data) => {
...
//           item.from,
//           item.value,
//           item.from === 'human' ? data.avatar_url : undefined
//         )
...
// function generate(from, value, url) {
//   const container = document.createElement('div')
//   container.style.width = '100%'
//   container.style.borderBottomWidth = '1px'
//   container.style.borderColor = 'rgba(17,24,39,0.5)'
//   container.style.color = from === 'human' ? '#ececf1' : '#d1d5db'
//   container.style.backgroundColor = from === 'human' ? '#343541' : '#444654'
...
//   const content = generateContent(from, value)
...
//     wrapper.style.backgroundColor = 'rgb(16, 163, 127)'
...
// function generateContent(from, value) {
//   const container = document.createElement('div')
//   container.style.position = 'relative'
//   container.style.display = 'flex'
//   container.style.flexDirection = 'column'
//   if (window.matchMedia('(min-width: 1024px)').matches) {
//     container.style.width = 'calc(100%-115px)'
//   } else if (window.matchMedia('(min-width: 768px)').matches) {
...
//   blank.style.justifyContent = 'space-between'
